...
The delivery of public assistance programs relies on much more than just good technology. Strong technical implementation isn't enough to successfully deliver a program, but poor technical implementation is enough to ensure its failure. Given the complexities of service administration and delivery, where can technology be most useful? What is necessary to make it so? Where is it not an appropriate solution? How can agencies think about how to best leverage technology in the delivery of their programs?
